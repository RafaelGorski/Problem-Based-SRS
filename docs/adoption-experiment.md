...
states, released evidence, measurement source, threshold, exclusions, and both non-empty
start/end readings are present. Empty-string placeholders are rejected. `result` remains
`not_recorded` until the observation window closes;
