...
[![Version 2.5.0](https://img.shields.io/badge/version-2.5.0-green.svg)](https://github.com/RafaelGorski/Problem-Based-SRS/releases/tag/v2.5.0)
...
[**Skills Health Dashboard**](https://rafaelgorski.github.io/Problem-Based-SRS/skills-health.html).
...
### SRS Navigator canvas app

The graph UI is a **GitHub Copilot canvas extension**, installed separately from the
skills. Ask the Copilot app to install it directly from this repository:
