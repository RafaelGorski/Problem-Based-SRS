...
- **Testing:** See `docs/TESTING.md` and `tests/` for quality validation

## 🧪 Testing & Quality

This repository includes a comprehensive test suite to ensure skills and prompts follow AgentSkills best practices:
...
**36 automated tests** validate:
- ✅ YAML frontmatter structure
- ✅ Markdown formatting
- ✅ File organization
- ✅ 5-step methodology completeness
